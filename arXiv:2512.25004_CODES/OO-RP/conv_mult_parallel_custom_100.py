...
test_nr = 'RPOO_H6_4A_100i_parallel_NR_002'
...
def save_data(prefix, append):
    ...
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/random_pos_optimized_operator__CPU_threaded_1.0/random_pos_optimized_operator__CPU_threaded_2.0/RPOO_H6_4A_100i_parallel_NR_002_insert.pkl", "wb") as f:
        cp.dump(append, f)

def load_data(prefix):
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/random_pos_optimized_operator__CPU_threaded_1.0/random_pos_optimized_operator__CPU_threaded_2.0/RPOO_H6_4A_100i_parallel_NR_002_insert.pkl", "rb") as f:
        append = cp.load(f)
    return append

def main():
    if (os.path.exists("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/random_pos_optimized_operator__CPU_threaded_1.0/random_pos_optimized_operator__CPU_threaded_2.0/RPOO_H6_4A_100i_parallel_NR_002_insert.pkl")):
