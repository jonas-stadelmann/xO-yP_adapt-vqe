...
##############################################################
#define test number
test_nr = 'CALCULATION_H6_4A_OPT_OPT_10_OPERATORS_NR_001_30iter'
...
def save_data(prefix, append):
    ...
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_app_choice_10operator_correct_v1.0/CALCULATION_H6_4A_OPT_OPT_10_OPERATORS_NR_001_30iter_insert.pkl", "wb") as f:
        cp.dump(append, f)

def load_data(prefix):
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_app_choice_10operator_correct_v1.0/CALCULATION_H6_4A_OPT_OPT_10_OPERATORS_NR_001_30iter_insert.pkl", "rb") as f:
        append = cp.load(f)
    return append

def main():
    if (os.path.exists("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_app_choice_10operator_correct_v1.0/CALCULATION_H6_4A_OPT_OPT_10_OPERATORS_NR_001_30iter_insert.pkl")):
