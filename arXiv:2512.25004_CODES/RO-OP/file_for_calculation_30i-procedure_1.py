...
##############################################################
#define test number
test_nr = 'OPRO_H6_4A_30i-procedure_NR_001_100iter_1'
...
def save_data(prefix, append):
    ...
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_30i-procedure_NR_001_100iter_1_insert.pkl", "wb") as f:
        cp.dump(append, f)

def load_data(prefix):
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_30i-procedure_NR_001_100iter_1_insert.pkl", "rb") as f:
        append = cp.load(f)
    return append

def main():
    if (os.path.exists("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_30i-procedure_NR_001_100iter_1_insert.pkl")):
