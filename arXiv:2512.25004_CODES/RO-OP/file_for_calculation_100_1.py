...
##############################################################
#define test number
test_nr = 'OPRO_H6_4A_100i-calc_NR_001_100iter_1'

# not relevant for this application - allows to vary the positions for operator insertion in a tailored way
...
file_name_old_data = "H6_r=4_QE_204i_gradient_sliced_until_23_1.pkl"
file_directory = r'/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/adaptvqe/algorithms/stored_adapt-vqe_runs/'
##############################################################
...
def save_data(prefix, append):
    ...
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_100i-calc_NR_001_100iter_1_insert.pkl", "wb") as f:
        cp.dump(append, f)

def load_data(prefix):
    with open("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_100i-calc_NR_001_100iter_1_insert.pkl", "rb") as f:
        append = cp.load(f)
    return append

def main():
    if (os.path.exists("/home/jonas/Documents/03_dplts/paper_writing/calculations/codes/optimized_position_random_operator_10operators_v1.0/OPRO_H6_4A_100i-calc_NR_001_100iter_1_insert.pkl")):
